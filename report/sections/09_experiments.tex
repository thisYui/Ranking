...
def pairwise_hinge_loss_and_grad(model, X, pairs, labels, reg=0.0):
    ...
    if np.any(violations):
        grad = np.mean((-labels[violations, None]) *
                       diffs[violations], axis=0)
...
Pairwise accuracy & 0.985051 \\
Ranking loss & 0.014949 \\
Kendall tau distance & 0.014949 \\
Top-10 overlap & 1.000000 \\
Final training loss & 0.114590 \\
\bottomrule
\end{tabular}
\end{table}

Kết quả cho thấy mô hình tuyến tính học được ranking tốt trên dữ liệu tổng hợp. Pairwise accuracy đạt khoảng \(0.985\), ranking loss và Kendall tau distance đều xấp xỉ \(0.015\). Top-10 overlap bằng \(1.0\), nghĩa là mô hình khôi phục đúng toàn bộ \(10\) phần tử đứng đầu.
...
\midrule
0.0 & 0.999192 & 0.000808 & 0.000808 & 1.0 \\
0.1 & 0.985051 & 0.014949 & 0.014949 & 1.0 \\
0.3 & 0.945859 & 0.054141 & 0.054141 & 1.0 \\
0.5 & 0.913939 & 0.086061 & 0.086061 & 0.8 \\
1.0 & 0.838182 & 0.161818 & 0.161818 & 0.7 \\
\bottomrule
\end{tabular}
\end{table}
...
Khi nhiễu tăng, chất lượng ranking giảm rõ rệt. Với \(\sigma=0.0\), dữ liệu gần như hoàn toàn tuyến tính nên pairwise accuracy gần bằng \(1\). Khi \(\sigma=1.0\), pairwise accuracy giảm xuống khoảng \(0.838\), ranking loss tăng lên khoảng \(0.162\), và top-10 overlap giảm còn \(0.7\). Điều này cho thấy nhiễu làm quan hệ ưu tiên kém ổn định hơn, khiến mô hình khó khôi phục ranking đúng.
...
\midrule
20  & 0.973684 & 0.026316 & 0.026316 & 0.9 \\
50  & 0.979592 & 0.020408 & 0.020408 & 0.9 \\
100 & 0.985051 & 0.014949 & 0.014949 & 1.0 \\
200 & 0.985930 & 0.014070 & 0.014070 & 0.9 \\
500 & 0.984970 & 0.015030 & 0.015030 & 1.0 \\
\bottomrule
\end{tabular}
\end{table}
